...
Целью освоения дициплины <<Программирование на языке Питон>> является: изучение и получение практических навыков использования языке Питон (Python), в том числе для анализа данных.
