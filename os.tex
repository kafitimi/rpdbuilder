...
\usepackage[
  ...
  pdfauthor={составлена Павлов Александр Викторович, к.~ф.-м.~н., ---, доцент кафедры информационных технологий ИМИ СВФУ}, 
...
\\[2mm]
\textbf{Б1.Б.10\ -- Операционные системы} 
\\[5mm]
...
Б1.Б.10\ -- Операционные системы} \\
Трудоемкость \uline{~7~} з.~е.
\end{center}


\subsection{Цель освоения и краткое содержание дисциплины}
Целью освоения дициплины <<Операционные системы>> является
...
\hline
Код и название дисциплины по учебному плану & \multicolumn{2}{p{6cm}|}{Б1.Б.10\ -- Операционные системы }\\
\hline
Курс изучения &\multicolumn{2}{c|}{ 1, 2 }\\
\hline
Семестр(ы) изучения &\multicolumn{2}{c|}{ 2, 3 }\\
\hline
...
\hline
Трудоемкость (в ЗЕТ) &\multicolumn{2}{c|}{ 4 / 3 (7) }\\
\hline
{\bf Трудоемкость (в часах)} (сумма строк №1,2,3), в~т.ч.:& \multicolumn{2}{c|}{144 / 72}\\
\hline
...
\hline  
Объем работы (в часах) (1.1.+1.2.+1.3.)& 91 / 42 & \\
\hline
1.1. Занятия лекционного типа (лекции) & 23 / 14 & \\
\hline
1.2. Занятия семинарского типа, всего, в т.ч.: & & \\
\hline
- семинары (практические занятия, коллоквиумы и~т.~п.)  & 22 / – & \\
\hline
- лабораторные работы& 46 / 28 & \\
\hline
- практикумы & & \\
\hline
1.3. КСР (контроль самостоятельной работы, консультации)& 5 / 3 & \\
\hline
{\bf №\,2. Самостоятельная работа обучающихся (СРС) (в часах)}& \multicolumn{2}{c|}{48 / 27}\\
\hline
...
\begin{longtable}{|p{5cm}|c|c|c|c|c|c|c|c|c|c|c|}
\caption{}\\
\hline
Тема & 
\rotleft{Лекции} &
\rotleft{из них с применением  ЭО и ДОТ} &
\rotleft{Семинары  (практические занятия, коллоквиумы)} &
\rotleft{из них с применением  ЭО и ДОТ} &
